...
switch test
    ...
    case 14
        ...
        xlim        = [-0.5, 2.5];
        xtick       =-0.5:0.5:2.5;
        xticklabel  = ["-0.5", "0.0", "0.5", "1.0", "1.5", "2.0", "2.5"];
        %------------------------------------------------------------------
        ylim        = [0.85, 3.00];
        ytick       = [0.85, 1.00:0.50:3.00];
        yticklabel  = ["0.85", "1.00", "1.50", "2.00", "2.50", "3.00"];
        %------------------------------------------------------------------
        xtitle      = "$x$";
        ytitle      = "$\zeta^{\prime}$";
        %------------------------------------------------------------------
        ...
        xlim        = [1, 5e3];
        xtick       = 1:1e3:5e3;
        xticklabel  = ["1", "1000", "2000", "3000", "4000", "5000"];
        %------------------------------------------------------------------
        ylim        = [1e-16, 1e-08];
        ytick       =-16:1:-08;
        yticklabel  = ["-16", "-15", "-14", "-13", "-12", "-11", "-10", "-09", "-08"];
        %------------------------------------------------------------------
        xtitle      = "$x$";
        ytitle      = "$\zeta^{\prime}$";
        %------------------------------------------------------------------
